"use client"; // OBLIGATOIRE : Nous utilisons des hooks et de l'état client
...
export default function Navbar() {
  // Sécurité anti-Hydration Mismatch
  ...
  // Calcul dynamique et réactif du nombre total d'articles
      ...
      <div className="container mx-auto flex h-16 items-center gap-4 px-4">
        ...
        <nav className="flex items-center gap-1 sm:gap-3">
          ...
          <Button variant="ghost" size="icon" className="relative text-turquoise hover:bg-turquoise/10">
            ...
            {/* Condition stricte : Monté + Supérieur à 0 */}
